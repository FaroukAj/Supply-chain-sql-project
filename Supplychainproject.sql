...
-- Analytical Business Question Answered: Customers in "Chicago" experience a comparatively higher late delivery risk, highlighting the need for improved logistical operations or customer communication in this region.
...
-- Analytical Business Question Answered: With "Chicago" having the highest delivery percentage risk, and actual late delivery percentage is highest suggests ineffective delivery management. This highlights the importance of implementing robust shipping strategies to enhance overall service reliability and further mitigate potential risks.
...
-- The "Technology" department stands out with the highest average sales per customer, indicating potential avenues for further optimization and expansion.
...
--Analytical Business Question Answered: The "Fan shop" department is a major revenue driver, suggesting the importance of maintaining and enhancing offerings in this category.
...
LIMIT 10;
--Analytical Business Question Answered: "Chicago" leads revenue generation in the USA, indicating a significant market presence and potential for further market penetration strategies.
...
ORDER BY Total_Revenue_Per_City DESC
LIMIT 10;
--Applied similar analysis to Puerto Rico, with "Caguas" identified as the top revenue-generating city.
-- Analytical Business Question Answered: "Caguas" is the primary revenue contributor in Puerto Rico, suggesting targeted efforts to capitalize on this key market.
...
LIMIT 10;
-- Analytical Business Question Answered: The "Consumer" segment is a major revenue source generating over $170 million, warranting tailored strategies to further engage and retain these customers.
...
LIMIT 5;
-- Analytical Business Question Answered: "Customer_ID 791" is a significant high-value customer, suggesting personalized engagement strategies and potential cross-selling opportunities.
...
LIMIT 10;
-- Analytical Business Question Answered: "Sport jersey" is a top seller, guiding inventory management and promotional efforts for sustained success.
